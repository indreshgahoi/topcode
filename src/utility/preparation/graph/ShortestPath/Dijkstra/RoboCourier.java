...
public class RoboCourier {
	...
	int shortestpath() {
		...
		while (pq.size() > 0) {
			...
			/*
			 * if(pq.contains(pq.first())){ System.out.println("hello"+pq.first()); } else {
			 * System.out.println("not find"+pq.first()); } pq.remove(curr);
			 */
	...
	public static void main(String[] args) {
		...
		System.out.println("" + (task.timeToDeliver(new String[] { "FFLRLFRRFRFFRLFRLRLRLRLRLFFRLRLRLFRLFRFFLLFFFFR",
				"RLFFLRLFRFFFLLFFFFFRFRLFLRLRFFFLFFFRFFFFFLFFFFF", "FFFRLRFFRFFFRFLRFFFLRFFFLRFFRLFFFFFFFRLFFFLRLRL",
				"RLFRLFFFRLRLRFLRLFFFFFFFRLFFFFRFFFRRFLFFFFFLLFF", "FFRLFFFFRFFLFFLFRLFFFFFFFFFFRFFFFFLFRLRRFFFLRLF",
				"LFRLFFFFFFFFFRFFFLRFFFFFFFRLFLFLRRFLFFFRFFFLLFF", "RFFLFFRFFRFFFFFFFRFFFRFLFFLRFFRLFFFFFFFLFFLFFLR",
				"FFFFRFFFFFRLFFFFLFFLRFFFLFFFFFFFFLFLFFRRLRLRLRF", "FFRFLFFFLRFFLRLLFRLRLRFFFRFFFFRFRRFLLFFFFRLRLRF",
